...
import com.ebankdigit.ebankingdigit.mappers.BankAccountMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService{
	...
	@Override
	public void debit(String accoundId, double amount, String description) throws BankAccountNotFoundException, BalanceNotSufficientException {
		BankAccount bankAccount = bankAccountRepository.findById(accoundId)
				.orElseThrow(()-> new BankAccountNotFoundException(""));
	...
	@Override
	public void transfer(String accoundIdSource, String accountIdDestination, double amount) throws BankAccountNotFoundException, BalanceNotSufficientException {
	...
	public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId)
		...
		savingAccount.setInterestedRate(interestRate);
